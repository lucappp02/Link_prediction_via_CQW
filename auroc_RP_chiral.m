...
function auroc = auroc_RP_chiral(BIOgrid_interactors_complete,number_rows_removed,max_number,N,phase)



BIOgrid_interactors_removed = remove_rows(BIOgrid_interactors_complete,number_rows_removed);

Prediction =link_prediction_chiral(BIOgrid_interactors_removed,N,max_number,phase);
